...
public class TheatersListView extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        restaurants = database.getReference("Theaters");

        //Load Restaurants
        // Using Firebase UI to The Recycler View
        recyclerView = (RecyclerView) findViewById(R.id.TheatersListView);
            ...
            protected void populateViewHolder(RestaurantViewHolder restaurantViewHolder, restaurant model, int position) {
                ...
                restaurantViewHolder.setItemClickListener(new ItemClickListener() {
                    ...
                    public void onClick(View view, int position, boolean isLongClick) {
                        ...
                        // Start New Activity
                        Intent restDetail = new Intent(getApplicationContext(), TheatersDetails.class);
